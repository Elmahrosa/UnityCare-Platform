      ...
      <div className="w-full max-w-md rounded-2xl bg-white p-8 shadow-lg">
        ...
        <form onSubmit={handleRegister} className="space-y-4">
          <div>
            ...
            <input type="text" value={form.full_name} onChange={(e) => setForm({ ...form, full_name: e.target.value })} className="mt-1 block w-full rounded-lg border border-gray-300 px-3 py-2 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500" required />
          </div>
          <div>
